package top.reid.smart.iot.db;

import cn.hutool.json.JSONObject;
import top.reid.smart.iot.db.handler.ColumnInfo;
import top.reid.smart.iot.db.handler.SqlHandlerFactory;
...
public class DatabaseServiceImpl implements DatabaseService {
    ...
    @Override
    public void createTableAndInsertData(String tableName, JSONObject jsonObject) throws SQLException {
        createTableByJson(tableName, jsonObject);
        insertByJson(tableName, jsonObject);
    }
    ...
    @Override
    public void insertByJson(String tableName, JSONObject jsonObject) throws SQLException {
        getConnection();
